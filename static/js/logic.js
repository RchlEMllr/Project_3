...
//ozone layer
 ...
 //nitrogen layer
  ...
  //sulfer layer
    ...
    let sulfer_dioxide = L.tileLayer('https://tiles.aqicn.org/tiles/usepa-so2/{z}/{x}/{y}.png?token=295dcb510bbc355e4e3441bae95aed6b7496884a', {
        attribution: '&copy; <a href="http://waqi.info">waqi.info</a>'
    }).addTo(myMap);
    //carbon layer
...
let Quality = [50,100,150,200,300,300]
